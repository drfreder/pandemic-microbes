...
```{r bioRxiv total preprints figure, message=FALSE, warning=FALSE, fig.width=8, fig.height=4, dpi=300}
...
```{r bioRxiv main figure, message=FALSE, warning=FALSE, fig.width=8, fig.height=4, dpi=300}
#By month
...
Summarize the same data, but visualize in a more concise form for the main text. 
...
How many medRxiv preprints are about SARS-CoV-2, COVID-19, or other coronaviruses, versus microbiomes or other microbes? 
...
We also compiled data on US National Institutes of Health (NIH) research project grants over the same period. 
...
```{r nih total grants figure, message=FALSE, warning=FALSE, fig.width=8, fig.height=8, dpi=300}
#By month
...
```{r NIH grant number figure, message=FALSE, warning=FALSE, fig.width=8, fig.height=8, dpi=300}
...
```{r NIH grant dollars figure, message=FALSE, warning=FALSE, fig.width=8, fig.height=8, dpi=300}
