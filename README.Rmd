...
Ecology and evolutionary biology account for just `r paste0(round(((sum.by.category[sum.by.category$category == "ecology" & sum.by.category$type == "COVID-19, SARS-CoV-2, or coronavirus", "percent"])+(sum.by.category[sum.by.category$category == "evolutionary biology" & sum.by.category$type == "COVID-19, SARS-CoV-2, or coronavirus", "percent"])), 1), "%")` of preprints on COVID-19, SARS-CoV-2, or coronaviruses, compared to `r paste0(round(((sum.by.category[sum.by.category$category == "ecology" & sum.by.category$type == "Microbiome or microbial community", "percent"])+(sum.by.category[sum.by.category$category == "evolutionary biology" & sum.by.category$type == "Microbiome or microbial community", "percent"])), 1), "%")` of preprints on microbiomes and microbial communities and `r paste0(round(((sum.by.category[sum.by.category$category == "ecology" & sum.by.category$type == "Other microbe", "percent"])+(sum.by.category[sum.by.category$category == "evolutionary biology" & sum.by.category$type == "Other microbe", "percent"])), 1), "%")` of preprints on other microbes.
